(() => {
  ...
  var CLASS_TT_HEADER = "header_MP_ header_8H_";
  var CLASS_TT_HEADER_CONTENT = "header-content_SqG header-content_wUX";
  var CLASS_TT_LABEL = "label_VRN";
  var CLASS_TT_ICON = "icon_nAL icon_I32";
  var CLASS_TT_CHILD_TOGGLE = "toggle_GGm toggle_cca";
  var CLASS_TT_ITEMMOUSESTATES = "item-mouse-states_Fmi";
  var CLASS_TT_ITEM_FOCUSED = "item-focused_FuT";
  var CLASS_TT_FOLDOUT = "foldout-item_dah foldout-item_wOF";
  var CLASS_TT_DISABLE_MOUSE_STATES = "disable-mouse-states_js5";
  var CLASS_TT_CHECKMARK = "checkmark_NXV";
  ...
  var $Panel = ({ title, children, react }) => {
    ...
    use_data_update_default(react, "extendedHotkeys.version", setVersion);
    const onMouseDown = (e) => {
      if (e.button !== 0)
        return;
  ...
  var ExtendedHotkeysUI = ({ react }) => {
    ...
    use_data_update_default(react, "extendedHotkeys.translations", setTranslations);
    ...
    use_data_update_default(react, "extendedHotkeys.enableNTMSimpleCurve", setEnableNTMSimpleCurve);
    const [enableNTMComplexCurve, setEnableNTMComplexCurve] = react.useState(true);
    use_data_update_default(react, "extendedHotkeys.enableNTMComplexCurve", setEnableNTMComplexCurve);
    const [enableNTMContinuous, setEnableNTMContinuous] = react.useState(true);
    use_data_update_default(react, "extendedHotkeys.enableNTMContinuous", setEnableNTMContinuous);
    const [enableNTMGrid, setEnableNTMGrid] = react.useState(true);
    use_data_update_default(react, "extendedHotkeys.enableNTMGrid", setEnableNTMGrid);
    ...
    const Setting = ({ setting, nested }) => {
      ...
      const checked_class = isChecked ? CLASS_CHECKED2 : CLASS_UNCHECKED2;
      const onToggle = () => {
      ...
      const renderChildren = () => {
        if (children && children.length > 0 && expanded) {
          return /* @__PURE__ */ import_react5.default.createElement("div", { className: "content_mJm foldout-expanded" }, children.map((child) => /* @__PURE__ */ import_react5.default.createElement(Setting, { key: child.id, setting: child, onToggle, nested: nested + 1 })));
        }
        return null;
      };
      ...
      const renderHotkeys = () => {
        if (hotkey) {
          return /* @__PURE__ */ import_react5.default.createElement("div", { className: CLASS_TT_HEADER_CONTENT, style: keyCodeStyle }, /* @__PURE__ */ import_react5.default.createElement("div", { className: CLASS_TT_LABEL }, hotkey));
        }
        return null;
      };
    ...
    return /* @__PURE__ */ import_react5.default.createElement($Panel, { title: "Extended Hotkeys", react }, /* @__PURE__ */ import_react5.default.createElement(SettingsList, { name: "General", settings: generalSettingsData }), /* @__PURE__ */ import_react5.default.createElement(SettingsList, { name: "Mouse Wheel", description: "Extended actions with your mouse wheel while in net tool placing roads.", settings: mouseWheelSettingsData }), /* @__PURE__ */ import_react5.default.createElement(SettingsList, { name: "Hotkeys", description: "Awesome actions with your keyboard.", settings: staticHotkeysSettingsData }));
  };
